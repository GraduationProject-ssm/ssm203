...
# ssm203基于vue的线上点餐系统+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=2)
...
|heji|varchar(200)|是|NULL|合计|
|tupian|varchar(200)|是|NULL|图片|
|yuancailiao|varchar(200)|是|NULL|原材料|
|pengrenfangfa|varchar(200)|是|NULL|烹饪方法|
...
图5.3 用户信息管理界面
### 5.1.3 订单信息管理
系统管理员可以对订单进行查询，审核以及查看评价信息，。界面如下图所示：

![](/md/blog.012.png)

图5.4 订单信息管理界面
### 5.1.4 菜品类别管理
系统管理员可以对菜品类别进行添加修改删除操作。界面如下图所示：
...
## 5.2 用户模块的实现
### 5.2.1 系统首页
系统首页上面有导航，可以看到菜品信息，美食资讯以及个人中心之类的点击操作，首页可以显示美食信息。界面如下图所示：
